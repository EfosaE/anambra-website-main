  ...
  return (
    <section className="px-4 md:px-20 py-16">
      <div className="max-w-[1201px] mx-auto">
        ...
        {articles.length === 0 ? (
          <p className="text-center text-gray-600 text-lg">No news articles available at the moment.</p>
        ) : (
          <>
              ...
              {articles.map((article) => (
                ...
                >
                  <div className="relative w-full h-[217px] overflow-hidden rounded-lg bg-gray-200 group">
                    <Image
                      src={article.cover?.url || "/images/placeholder.png"}
                      alt="Cover photo"
                      fill
                  ...
                  <time className="text-xs text-gray-500">
                    {new Date(article.Article_publish_date).toLocaleDateString("en-US", {
                      month: "short",
                      day: "2-digit",
                      year: "numeric",
                    })}
